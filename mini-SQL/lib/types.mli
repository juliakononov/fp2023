...
type column = { column_name : string; column_type : column_type; }
type header = column array
type table = { table_name : string; table_header : header; }
...
module Table :
  sig
    type t = { data : Sheet.t; meta : table; }
    val name : t -> string
...
module Database :
  sig
    type t = { tables : Table.t list; name : string; }
    val name : t -> string
